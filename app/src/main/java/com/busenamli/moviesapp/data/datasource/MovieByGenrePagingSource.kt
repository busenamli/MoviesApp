...
class MovieByGenrePagingSource @Inject constructor(private val moviesService: MoviesService, private val genreId: Int): PagingSource<Int, MovieModel>()  {

    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, MovieModel> {
        try {
            val pageNumber = params.key ?: 1
            val response = moviesService.fetchMoviesByGenreList(Constants.API_KEY, Constants.LANGUAGE, genreId, pageNumber)
